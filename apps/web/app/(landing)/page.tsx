        ...
        <section className="w-full  flex flex-col items-center gap-10 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="bg-white rounded-lg border border-neutral-200 shadow-sm p-6 order-2 lg:order-1">
              <div className="mb-6" id="demo-tabs">
                <div className="flex border-b border-neutral-200">
                  <button
                    className="px-4 py-2 font-medium border-b-2 font-Nunito text-neutral-500 border-transparent hover:border-[#8B4513]/30"
                    data-tab="summarize"
                  >
                    Summarize
                  </button>
                  <button
                    className="px-4 py-2 hover:text-[#8B4513] font-medium border-b-2 transition-colors duration-200 font-Nunito text-[#8B4513] border-[#8B4513]"
                    data-tab="rewrite"
                  >
                    Rewrite
                  </button>
                  <button
                    className="px-4 py-2 hover:text-[#8B4513] font-medium border-b-2 transition-colors duration-200 font-Nunito text-neutral-500 border-transparent hover:border-[#8B4513]/30"
                    data-tab="grammar"
                  >
                    Grammar
                  </button>
              ...
              <div className="relative">
                <div
                  ...
                  className="demo-content hidden"
                  data-tab-content="summarize"
                >
                  <div className="mb-4">
                    <label className="block text-neutral-700 font-medium mb-2 font-Nunito">
                      Original Text
                    </label>
                    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 h-40 overflow-y-auto">
                      <p className="text-neutral-700 font-Nunito">
                        Artificial intelligence has made significant strides in
                        recent years, transforming industries and reshaping how
                        we interact with technology. Machine learning
                        algorithms, neural networks, and natural language
                        processing have enabled computers to perform tasks that
                        once required human intelligence. From self-driving cars
                        to voice assistants, AI applications continue to expand.
                        However, these advancements also raise important ethical
                        considerations about privacy, bias, and the future of
                        human work. As AI becomes more integrated into daily
                        life, balancing innovation with responsible development
                        remains a crucial challenge for technologists,
                  ...
                  <div className="text-center mb-4">
                    <button
                      id="summarize-btn"
                      className="bg-[#8B4513] hover:bg-[#6d3610] text-white py-2 px-6 rounded-full inline-flex items-center font-Nunito transition-colors duration-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    ...
                    <div className="bg-[#8B4513]/5 border border-[#8B4513]/20 rounded-lg p-4">
                      <p
                        className="text-[#8B4513] font-Nunito"
                        id="summary-result"
                      >
                        AI has advanced rapidly, transforming industries through
                        machine learning, neural networks, and natural language
                        processing. While AI applications like self-driving cars
                        and voice assistants proliferate, they raise ethical
                        concerns about privacy, bias, and employment. Balancing
                        innovation with responsible development remains
                        essential.
                      </p>
                    </div>
                  </div>
                ...
                <div
                  id="rewrite-content"
                  className="demo-content block"
                  data-tab-content="rewrite"
                >
                  <div className="mb-4">
                    <label className="block text-neutral-700 font-medium mb-2 font-Nunito">
                      Original Text
                    ...
                    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 h-40 overflow-y-auto">
                      <p className="text-neutral-700 font-Nunito">
                        Our company sells products that are good for people who
                        want to save money and get stuff that works well. We
                        have been selling things for a long time and our
                        customers like us. You should buy from us because we are
                  ...
                  <div className="text-center mb-4">
                    <button
                      id="rewrite-btn"
                      className="bg-[#D4AF37] hover:bg-[#ba9729] text-white py-2 px-6 rounded-full inline-flex items-center font-Nunito transition-colors duration-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 mr-2"
                  ...
                  <div>
                    ...
                    <div className="bg-[#D4AF37]/5 border border-[#D4AF37]/20 rounded-lg p-4">
                      <p
                        ...
                        id="rewrite-result"
                      >
                        Our established company offers cost-effective,
                        high-quality solutions designed for budget-conscious
                        consumers seeking reliable performance. With a proven
                        track record of customer satisfaction, we distinguish
                        ourselves from competitors through superior value and
                        service excellence.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 h-40 overflow-y-auto">
                      <p className="text-neutral-700 font-Nunito">
                        Im going to the store to buy some apple&apos;s and
                        orange&apos;s for the party. Their going to be alot of
                        people their, and we need to make sure we have enough
                        food. Me and my friend John is setting up the
                        decorations early, so everything look good for when the
                        guest arrive.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-[#8B4513]/5 border border-[#8B4513]/20 rounded-lg p-4">
                      <p
                        ...
                        id="grammar-result"
                      >
                        I&apos;m going to the store to buy some apples and
                        oranges for the party. There&apos;s going to be a lot of
                        people there, and we need to make sure we have enough
                        food. My friend John and I are setting up the
                        decorations early, so everything looks good for when the
                        guests arrive.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-4 h-40 overflow-y-auto">
                      <p className="text-neutral-700 font-Nunito">
                        ...
                        we&apos;re pushing back the deadline to next Friday. No
                        big deal, but make sure you get your stuff in by then.
                  ...
                  <div className="text-center mb-4">
                    <div className="inline-flex bg-neutral-100 rounded-full p-1">
                      <button
                        ...
                        className="tone-btn py-1 px-4 rounded-full font-Nunito text-sm bg-transparent text-neutral-500 hover:text-[#8B4513]"
                      >
                        Professional
                      </button>
                      <button
                        data-tone="academic"
                        className="tone-btn py-1 px-4 rounded-full font-Nunito text-sm bg-[#D4AF37] text-white"
                      >
                        Academic
                      </button>
                      <button
                  ...
                  <div>
                    ...
                    <div className="bg-[#D4AF37]/5 border border-[#D4AF37]/20 rounded-lg p-4">
                      <p
                        ...
                        id="tone-result"
                      >
                        The deadline for submission has been extended to the
                        forthcoming Friday. It is imperative that all materials
                        be submitted by this date. Should any inquiries arise
                        regarding this matter, communication is welcomed at your
                        convenience.
                      </p>
                    </div>
                  </div>
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl font-bold text-[#8B4513] mb-4 font-Fraunces">
                Experience the Power of OwlScribe
              </h3>
              <p className="text-neutral-700 mb-6 font-Nunito">
                OwlScribe transforms how you write with powerful AI that adapts
                to your needs. Try our interactive demo to see how it works.
              </p>
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-neutral-700 font-Nunito">
                      ...
                      Get transformations in seconds, not minutes.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-neutral-700 font-Nunito">
                      ...
                      Switch between summarize, rewrite, fix, and tone adjust.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-neutral-700 font-Nunito">
                      ...
                      Smart AI that understands your text&apos;s meaning and
                      purpose.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-neutral-700 font-Nunito">
                      ...
                      Use in emails, documents, social media, and more.
                    </p>
                  </div>
                </li>
              </ul>
